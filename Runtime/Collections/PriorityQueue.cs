...
namespace GameplayAbilities
{
    ...
    public class PriorityQueue<TElement, TPriority>
    {
        ...
        public PriorityQueue(int initialCapacity, IComparer<TPriority>? comparer)
        {
            ...
            {
                throw new ArgumentOutOfRangeException(nameof(initialCapacity), initialCapacity, $"{nameof(initialCapacity)} ('{initialCapacity}') must be a non-negative value.");
            }
        ...
        public int EnsureCapacity(int capacity)
        {
            if (capacity < 0)
            {
                throw new ArgumentOutOfRangeException(nameof(capacity), capacity, $"{nameof(capacity)} ('{capacity}') must be a non-negative value.");
            }
